...
class GoalUpdateBottomSheet extends StatefulWidget {
  final int? goalId;
  final Future<void> Function(String name, Color color)? create;

  const GoalUpdateBottomSheet({
    super.key,
    this.goalId,
    this.create,
  });
  ...
  @override
  State<GoalUpdateBottomSheet> createState() => _GoalUpdateBottomSheetState();
}

class _GoalUpdateBottomSheetState extends State<GoalUpdateBottomSheet> {
