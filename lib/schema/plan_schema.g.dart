...
void _planSerialize(
  ...
  writer.writeLong(offsets[7], object.visionId);
}
...
Plan _planDeserialize(
  ...
  object.visionId = reader.readLong(offsets[7]);
  return object;
}
...
extension PlanQueryFilter on QueryBuilder<Plan, Plan, QFilterCondition> {
  ...
  QueryBuilder<Plan, Plan, QAfterFilterCondition> isDeleteEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isDelete',
        value: value,
...
extension PlanQuerySortBy on QueryBuilder<Plan, Plan, QSortBy> {
  ...
  QueryBuilder<Plan, Plan, QAfterSortBy> sortByIsDelete() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDelete', Sort.asc);
    });
  }

  QueryBuilder<Plan, Plan, QAfterSortBy> sortByIsDeleteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQuerySortThenBy on QueryBuilder<Plan, Plan, QSortThenBy> {
  ...
  QueryBuilder<Plan, Plan, QAfterSortBy> thenByIsDelete() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDelete', Sort.asc);
    });
  }

  QueryBuilder<Plan, Plan, QAfterSortBy> thenByIsDeleteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDelete', Sort.desc);
    });
  }
...
extension PlanQueryWhereDistinct on QueryBuilder<Plan, Plan, QDistinct> {
  ...
  QueryBuilder<Plan, Plan, QDistinct> distinctByIsDelete() {
    return QueryBuilder.apply(this, (query) {
...
extension PlanQueryProperty on QueryBuilder<Plan, Plan, QQueryProperty> {
  ...
  QueryBuilder<Plan, bool, QQueryOperations> isDeleteProperty() {
    return QueryBuilder.apply(this, (query) {
